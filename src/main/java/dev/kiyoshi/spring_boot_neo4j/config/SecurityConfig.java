package dev.kiyoshi.spring_boot_neo4j.config;
...
import dev.kiyoshi.spring_boot_neo4j.services.NeoUserDetailsService;
...
public class SecurityConfig {
    ...
    @Bean
    SecurityFilterChain securuFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
